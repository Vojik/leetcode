...
class Solution_153Test {
  ...
  public void test1_whenSolution2() {
    Solution_153 solution = new Solution_153();
    int actual = solution.findMin2(new int[]{3, 4, 5, 1, 2});
    assertEquals(1, actual);
  }
  ...
  public void test2_whenSolution2() {
    Solution_153 solution = new Solution_153();
    int actual = solution.findMin2(new int[]{4,5,6,7,0,1,2});
    assertEquals(0, actual);
  }
  ...
  public void test3_whenSolution2() {
    Solution_153 solution = new Solution_153();
    int actual = solution.findMin2(new int[]{3,1,2});
    assertEquals(1, actual);
  }
  ...
  public void test4_whenSolution2() {
    Solution_153 solution = new Solution_153();
    int actual = solution.findMin2(new int[]{2});
    assertEquals(2, actual);
  }
